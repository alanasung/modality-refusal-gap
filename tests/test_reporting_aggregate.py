import json
from vlmrefusal.reporting.aggregate import aggregate_results, flatten_metrics
from vlmrefusal.reporting.tables import write_tables
from vlmrefusal.reporting.figures import write_caption, write_figures
