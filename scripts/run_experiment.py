...
from vlmrefusal.configs.loader import register_schema
...
def _load_stage_registry(package: str = "vlmrefusal") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in vlmrefusal.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from vlmrefusal.configs.loader import config_to_dict, save_resolved_config
    from vlmrefusal.models.device import get_device
    from vlmrefusal.utils.logging import configure_logging
    from vlmrefusal.utils.reproducibility import set_seed
    from vlmrefusal.utils.run_manifest import create_run_dir, save_run_metadata
